                ...
                <div className="row">
                    <div className="col-sm-3">
                        <div className="s-f-links">
                            <a onClick={()=>gotoPage()} className="" role="button">Terms of service</a>
                            <a onClick={()=>gotoPage()} className="" role="button">Privacy Policy</a>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-3">
                        <ul>
                            ...
                            <li><a role="button" onClick={()=>gotoPage()}><svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M2 0H12C13.1046 0 14 0.89543 14 2V18L7.09495 13L0 18V2C0 0.89543 0.89543 0 2 0Z" fill="#BAC3CA"/></svg></a></li>
                        </ul>
                    </div>
                </div>
            </div>
